...
/**
 * Normal block placement on any face; when clicking an existing rod, also stacks one block ahead along
 * {@link TurbineRodBlock#FACING} if that cell is replaceable.
 */
