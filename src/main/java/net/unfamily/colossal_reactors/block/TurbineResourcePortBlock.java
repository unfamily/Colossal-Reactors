...
public class TurbineResourcePortBlock extends BaseEntityBlock {

    public static final MapCodec<TurbineResourcePortBlock> CODEC = simpleCodec(TurbineResourcePortBlock::new);

    public TurbineResourcePortBlock(Properties properties) {
        super(properties);
    }
    ...
    public BlockEntity newBlockEntity(BlockPos pos, BlockState state) {
        return new TurbineResourcePortBlockEntity(pos, state);
    }
    ...
    protected InteractionResult useWithoutItem(BlockState state, Level level, BlockPos pos, Player player, BlockHitResult hitResult) {
        ...
        if (be instanceof ResourcePortBlockEntity resourcePort && player instanceof ServerPlayer serverPlayer) {
