...
/**
 * Resizes resource port fluid tanks from estimated per-tick demand (× {@link Config#PORT_DEMAND_MULTIPLIER}),
...
public final class MultiblockPortScaling {
    ...
    public static void scaleTurbinePorts(ServerLevel level, TurbineControllerBlockEntity controller) {
        ...
        int demandMb = steamPerTick;
        int target = scaledTargetMb(minMb, demandMb, multiplier);
