 ...
 * Falls back to standard Forge {@code IEnergyStorage} in {@link net.unfamily.colossal_reactors.blockentity.PowerPortBlockEntity#tick()}.
 */
public final class FluxNetworksLongEnergyBridge {
    ...
    /** {@code null} = not resolved yet; {@code Boolean.FALSE} = Flux absent or failed; otherwise {@link BlockCapability}. */
    @Nullable
